...
void load_device_properties() {
    property_override("ro.build.fingerprint", "google/raven/raven:12/SP2A.220705.003/8672226:user/release-keys");
    property_override("ro.build.description", "raven-user 12 SP2A.220705.003 8672226 release-keys");
